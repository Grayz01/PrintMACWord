...
document.addEventListener('DOMContentLoaded', function() {
            ...
            function showResult(data) {
                try {
                    ...
                    if (!resultSection || !successMessage || !successDetail || !fileName || !fileMaHopDong || !fileIdHopDong || !filePath || !fileSize) {
            ...
            if (createBtn) {
                createBtn.addEventListener('click', function() {
                    ...
                    const formFields = [
                        'maHopDong', 'ho_ten', 'nam_sinh', 'so_dt', 'cccd_so', 'ngay_cap', 
                        'noi_cap', 'noi_dktt', 'ten_tai_san', 'so_tien', 
