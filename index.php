...
<body>
    ...
    <div class="loading-overlay" id="loadingOverlay">
        <div class="loading-content">
            ...
            <div class="loading-subtext">Đang tạo hợp đồng, vui lòng chờ</div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="form-container">
            ...
            <form id="contractForm">
                ...
                <div class="row mb-3">
                    <label class="col-sm-2 col-form-label">CCCD Số</label>
                    <div class="col-sm-4">
                ...
                <div class="row mb-3">
                    <label class="col-sm-2 col-form-label">NƠI ĐKTT</label>
                    <div class="col-sm-10">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="so_tien" id="so_tien" placeholder="VD: 50,000,000" required>
                    </div>
                </div>
                ...
                <!-- Thời gian gia hạn -->
                <h5 class="section-title">
                    <i class="bi bi-calendar-range me-2"></i>THỜI GIAN GIA HẠN
                </h5>

                <div class="row mb-3">
                    <div class="col-sm-6">
                        <div class="row">
                            <label class="col-sm-4 col-form-label">Kỳ 1</label>
                            <div class="col-sm-8">
                    ...
                    <div class="col-sm-6">
                        <div class="row">
                            <label class="col-sm-4 col-form-label">Kỳ 2</label>
                            <div class="col-sm-8">
                ...
                <div id="resultSection" class="mt-4" style="display: none;">
                    <div class="success-box">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h5 class="mb-1">✅ Tạo hợp đồng thành công!</h5>
                                <p class="mb-2">File DOCX đã được tạo và mở bằng Microsoft Word.</p>
                                <div class="file-info">
                                    <strong><i class="bi bi-file-word me-2"></i>File:</strong> 
                                    <span id="fileName" class="fw-bold"></span><br>
                                    <strong><i class="bi bi-folder me-2"></i>Vị trí:</strong> 
                                    <span id="filePath" class="text-muted"></span>
                                </div>
                                <div class="mt-3">
                                    <p class="mb-2">
                                        <i class="bi bi-info-circle me-1"></i>
                                        Sử dụng Microsoft Word để in hợp đồng (File → Print)
                                    </p>
                                    <button type="button" class="btn btn-outline-primary me-2" id="openWordBtn">
                                        <i class="bi bi-microsoft me-2"></i>Mở lại bằng Word
                                    </button>
                                    <button type="button" class="btn btn-outline-success" id="createAnotherBtn">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function validateForm() {
            ...
            if (gio) {
                const gioNum = parseInt(gio);
                if (gioNum < 0 || gioNum > 23 || isNaN(gioNum)) {
                    document.getElementById('gio').classList.add('is-invalid');
                    isValid = false;
                    if (!firstInvalidField) firstInvalidField = document.getElementById('gio');
                }
            }
            
            if (phut) {
                const phutNum = parseInt(phut);
                if (phutNum < 0 || phutNum > 59 || isNaN(phutNum)) {
                    document.getElementById('phut').classList.add('is-invalid');
                    isValid = false;
                    if (!firstInvalidField) firstInvalidField = document.getElementById('phut');
                }
            }
        ...
        document.getElementById('createBtn').addEventListener('click', function() {
            ...
            .then(response => {
                ...
                // Nếu response không ok, thử đọc text để debug
                if (!response.ok) {
